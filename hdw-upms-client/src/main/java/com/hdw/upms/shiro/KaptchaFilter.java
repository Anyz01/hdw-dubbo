...
/**
 * 
 * @Descriptin 验证码过滤器此过滤器已经在shiro中配置，这里不需要再次配置拦截路径
 * @author TuMinglong
 * @Date 2018年5月1日 下午2:41:50
 */
public class KaptchaFilter extends FormAuthenticationFilter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response)
        ...
        try {
            logger.info("KaptchaFilter.executeLogin");
            /*图形验证码验证*/
    ...
    protected void doCaptchaValidate(HttpServletRequest request, CaptchaUsernamePasswordToken token) {
        ...
        logger.info("session中的图形码字符串:" + captcha);
