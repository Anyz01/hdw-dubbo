package com.hdw.dubbo.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setTablePrefix(new String[] { "t_p_", " " });// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		strategy.setInclude(new String[] { "t_p_real_data"}); // 需要生成的表
		...
		pc.setParent("com.hdw.dubbo.search"); // 自定义包路径
